...
export default function CursorGlow() {
  ...
  // Use a ref for the last interactive element to avoid stale closures
  // inside the rAF callback without needing to re-register the listener.
  ...
  useEffect(() => {
    ...
    const processMove = () => {
      ...
      if (interactive) {
        ...
        // avoids forced style recalculation on every mousemove.
        ...
        // Only update state if it actually changed (avoids unnecessary renders)
